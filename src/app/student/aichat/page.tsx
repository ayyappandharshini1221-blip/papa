...
export default function StudentAIChatPage() {
  const initialMessages = [
    {
      role: 'model' as const,
      content: [{ text: 'Hello! I am EduSmart AI. As a student, you can ask me for explanations on complex topics, help with homework, or quiz preparation tips. How can I help you learn today?' }],
    },
  ];
