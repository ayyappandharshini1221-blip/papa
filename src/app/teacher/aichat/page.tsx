...
export default function TeacherAIChatPage() {
  const initialMessages = [
    {
      role: 'model' as const,
      content: [{ text: 'Hello! I am EduSmart AI. As a teacher, you can ask me to generate quiz ideas, create lesson plan outlines, or suggest activities for your class. How can I assist you today?' }],
    },
  ];
